...
<?php echo form_open_multipart(base_url() . 'videouploads/edit/' . $video['video_id']); ?>
					...
					<div class="">
							<div class="row">
								<div class="col-lg-6">
									...
									<input type="text" class="form-control" name="video_title" placeholder="Video Title" value="<?php echo $video['video_title'] ?>">
								</div>
								<div class="col-lg-3">
									<label>Document Number</label>
									<input type="text" class="form-control" name="document_no" placeholder="Document Number" value="<?php echo $video['document_no'] ?>">
								</div>
								<div class="col-lg-3">
								...
								<div class="col-lg-12 mt-3">
									...
									<textarea class="form-control" rows="10" name="video_description" placeholder="Video Description"><?php echo $video['video_description']; ?></textarea>
								</div>
							</div>
